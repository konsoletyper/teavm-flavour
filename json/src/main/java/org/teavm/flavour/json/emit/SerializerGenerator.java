 ...
 */
class SerializerGenerator implements Generator {
    private SerializerDependencyListener dependencyListener;

    public SerializerGenerator(SerializerDependencyListener dependencyListener) {
    ...
    public void generate(GeneratorContext context, SourceWriter writer, MethodReference methodRef) throws IOException {
        ...
        for (String className : classSource.getClassNames()) {
            String serializer = dependencyListener.getSerializer(className);
            if (serializer != null) {
                MethodReference ctor = new MethodReference(serializer, "<init>", ValueType.VOID);
